...
ITEM_PIPELINES = {
    'woaidu_crawler.pipelines.cover_image.WoaiduCoverImage': 100,
    'woaidu_crawler.pipelines.bookfile.WoaiduBookFile': 200,
   # 'woaidu_crawler.pipelines.mongodb_book_file.MongodbWoaiduBookFile': 300,
    'woaidu_crawler.pipelines.drop_none_download.DropNoneBookFile': 400,
    'woaidu_crawler.pipelines.mongodb.SingleMongodbPipeline': 500,
   # 'woaidu_crawler.pipelines.mongodb.ShardMongodbPipeline': 600,
    'woaidu_crawler.pipelines.final_test.FinalTestPipeline': 700,
    }
#ITEM_PIPELINES = ['woaidu_crawler.pipelines.WoaiduBookFile',: 800]
